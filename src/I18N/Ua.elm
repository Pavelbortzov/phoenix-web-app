    ...
    fromTree
        ...
        , ( "control"
          , object
                ...
                , ( "Положение", string "Положення" )
                , ( "Положение определено:", string "Положення визначено:" )
                , ( "Показать", string "Показати" )
                , ( "Обновить", string "Оновити" )
                ...
                , ( "Данные о состоянии еще не получены", string "Дані про стан ще не отримано" )
                , ( "идет определение...", string "відбувається визначення..." )
                , ( "Феникс выключен.", string "Фенікс вимкнений." )
                , ( "Идет определение местоположения...", string "Йде визначення місця розташування..." )
                , ( "Поиск", string "Пошук" )
                , ( "", string "" )
                ]
          )
        , ( "params"
          , object
                ...
                , ( "accel.deb", string "Программний антибрязкіт, число повторів (2-6)" )
                ...
                , ( "adc.u.off", string "Поріг відключення основного живлення, /29.528, V (100-1000)" )
                , ( "adc.u.on", string "Поріг включення основного живлення, /29.528, V (100-1000)" )
                ...
                , ( "sleep", string "Час "сну" в режимах Пошук і Очікування, хв" )
                ...
                , ( "alarm.low", string "SMS про низький рівень заряду батареї" )
                , ( "alarm.error", string "SMS про неможливість визначення координат" )
                , ( "alarm.gps", string "SMS про зміни координат" )
                , ( "alarm.mode", string "SMS про зміну режима" )
                , ( "alarm.on", string "SMS про увімкнення Фенікса" )
                , ( "alarm.off", string "SMS про вимкнення Фенікса" )
                , ( "alarm.stealth", string "SMS про активацію режиму Stealth" )
                , ( "admin", string "Номер телефону адміністратора" )
                ...
                , ( "balance.skip", string "Пропуск цифр у звіті оператора про баланс" )
                ...
                , ( "delay", string "Затримка вимкнення GSM-модуля, у циклах зв'язку" )
                ...
                , ( "gps.aoff", string "Автовіключення GPS для економії батареї, хв" )
                , ( "gps.delta", string "Примусова реєстрація координат при переміщенні, м" )
                , ( "gps.fail", string "Затримка перезапуску GPS-модулю при зникненні супутників, хв" )
                ...
                , ( "gps.tf.move", string "Примусова реєстрація координат при переміщенні, сек" )
                , ( "gps.tf.stop", string "Період реєстрації координат при зупинці, сек" )
                , ( "gps.tf", string "Період реєстрації координат, сек" )
                , ( "gps.tf.stop.acc", string "Період реєстрації координат при стоянці, сек" )
                , ( "gps.valid.delay", string "Дані від GPS беруться не перші після fix, а пропускается вказана  кількість" )
                , ( "gps.vignacc", string "Швидкість примусової реєстрації руху (ігнорується акселерометр) × 0,01852 км/год" )
                , ( "gps.vstart", string "Швидкість реєстрації початку руху × 0,01852 км/год" )
                , ( "gps.vstop", string "Швидкість реєстрації зупинки об'єкту × 0,01852 км/год" )
                , ( "gps.data.1", string "Призначення додаткового поля даних GPS" )
                ...
                , ( "gsm.flags", string "Работа у роумінгу, у тому числі, в національному" )
                , ( "gsm.lagtime", string "Період перевірки GSM-модуля на предмет зависання, хв" )
                , ( "gsm.predelay", string "Час перевірки GSM-ретрансляторів и очікування SMS, хв" )
                ...
                , ( "sms.confirm", string "Сповіщення про виколнання команди зміни режиму." )
                ...
                , ( "vin.off", string "Напруга автоматичного виключення Фенікса, V" )
                ]
          )
        ]
